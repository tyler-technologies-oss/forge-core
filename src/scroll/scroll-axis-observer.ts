...
import { ScrollAxis, IScrollObserverConfiguration, ScrollEvents, IScrollInfo, ScrollDirection } from './scroll-types';
...
export class ScrollAxisObserver extends EventAware implements IScrollAxisObserver {
  ...
  constructor(private _element: HTMLElement, private _config: IScrollObserverConfiguration = {}) {
    super();
    this._initialize();
  }
