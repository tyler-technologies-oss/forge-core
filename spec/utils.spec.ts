...
describe('Utils', () => {
  ...
  describe('nameof', () => {
    it('should return name of variable', () => {
      ...
      expect(Utils.nameof(function() { return simpleVarObj.simpleVar; })).toBe('simpleVar');
    });

    it('should return name of property with arrow function', () => {
      const obj = { simpleVar: true };
      expect(Utils.nameof(function() { return obj.simpleVar; })).toBe('simpleVar');
    });
    ...
    it('should return name of method with arrow function', () => {
      ...
      expect(Utils.nameof(function() { return obj.someMethod; })).toBe('someMethod');
    });

    it('should return name of property with function keyword', () => {
      const obj = { simpleVar: true };
      expect(Utils.nameof(function() { return obj.simpleVar; })).toBe('simpleVar'); // tslint:disable-line
    });
    ...
    it('should return name of method with function keyword', () => {
      ...
      TestObj.prototype.someMethod = () => {};
      const obj = new TestObj();
      expect(Utils.nameof(function() { return obj.someMethod; })).toBe('someMethod'); // tslint:disable-line
    });
  });
});
